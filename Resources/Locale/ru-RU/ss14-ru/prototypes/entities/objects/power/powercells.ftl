...
ent-PowerCellPotato = картофельная батарея
    .desc = Кто-то воткнул два гвоздя и несколько проводов в большую картофелину. Каким-то образом это обеспечивает небольшой заряд. Вы можете запихнуть её в слот среднего размера.
...
ent-PowerCellSmallNuclear = малоёмкая ядерная батарея
    .desc = Самозаряжающийся элемент питания, разработанный для быстрой зарядки за счёт ёмкости.
