...
ent-PosterContrabandCC64KAd = Реклама CC 64K
    .desc = Новейший портативный консоль от Comrade Computing, с целыми 64 килобайтами оперативной памяти!
...
ent-PosterContrabandRouny = Вы его видели?
    .desc = Старый плакат о пропавшем инопланетянине. Куда же он сбежал?
...
ent-PosterLegitReportCrimes = Сообщай обо всем!
...
ent-PosterLegitJustAWeekAway = Всего неделя...
    .desc = Плакат, рекламирующий давно отложенный проект, все ещё утверждает, что до него осталась 'всего неделя...'.
...
ent-PosterLegitPeriodicTable = Таблица Менделеева
    .desc = Периодическая таблица элементов, от водорода до оганессона, и все, что между ними.
...
ent-PosterLegitOppenhopper = Опергеймер
    .desc = Постер давно забытого фильма. В нем рассказывается о группе упорных салаг из сектора Мейн, которые противостоят атакам печально известных Ядерных Оперативников. Слоган гласит: «Атаки оперативников будут продолжаться, пока робастность не повысится».
ent-PosterLegitTyrone = Путеводитель Тайрона по космосу
    .desc = Плакат, рекламирующий онлайн-обучение космосу. Перечисленные курсы, похоже, охватывают все: от базового использования оборудования станции до таких сложных предметов, как создание трубных бомб или покрытие целых коридоров космической смазкой. Отказ от ответственности гласит: «Все не так уж плохо, и в конце вы даже можете получить тортилью».
