...
station-goal-solar-panels =
    ...
    Цель смены станции { $station } — постройка сети солнечных панелей в качестве резервной системы питания.[/bold]
...
station-goal-botany =
    ...
    Цель смены станции { $station } — постройка теплиц и выведение приспособленных к высокой температуре растений.[/bold]
