...
ion-storm-law-subjects-harmful = { $adjective } { $subjects } ПРИЧИНЯЮТ ВРЕД ЭКИПАЖУ
ion-storm-law-must-harmful = ВСЕ, КТО { $must }, ПРИЧИНЯЮТ ВРЕД ЭКИПАЖУ
# thing is a concept or action
ion-storm-law-thing-harmful = { $thing } ПРИЧИНЯЮТ ВРЕД ЭКИПАЖУ
ion-storm-law-job-harmful = { $adjective } { $job } ПРИЧИНЯЮТ ВРЕД ЭКИПАЖУ
# thing is objects or concept, adjective applies in both cases
# this means you can get a law like "NOT HAVING CHRISTMAS-STEALING COMMUNISM IS HARMFUL TO THE CREW" :)
ion-storm-law-having-harmful = НАЛИЧИЕ { $adjective } { $thing } ПРИЧИНЯЕТ ВРЕД ЭКИПАЖУ
ion-storm-law-not-having-harmful = ОТСУТСТВИЕ { $adjective } { $thing } ПРИЧИНЯЕТ ВРЕД ЭКИПАЖУ
