...
job-name-drone = дрон БС
job-description-drone = Маленький быстрый дрон. Придерживайтесь своих законов, служите экипажу и держите.. или хотя бы пытайтесь держать станцию в адекватном состоянии.
