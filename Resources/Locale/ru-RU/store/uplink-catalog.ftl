...
uplink-hypereutactic-blade-desc = Гигантский энергетический меч, сила которого соответствует его внешнему виду. Требует двух рук. Медленный и громоздкий, но довольно искусный в отражении. Ранее прославился благодаря оперативнику в маске радости. Вы бы не хотели увидеть, как он несётся на вас по коридору!
...
uplink-singularity-grenade-desc = Граната, имитирующая силу сингулярности, создаёт мощный гравитационный колодец.
uplink-whitehole-grenade-name = Граната белой дыры
uplink-whitehole-grenade-desc = Граната, которая отталкивает все вокруг в течение примерно 10 секунд. Очень полезно в небольших помещениях и при преследовании.
uplink-penguin-grenade-name = Пингвин-гренадер
...
uplink-grenadier-rig-name = Тактический жилет гренадера
uplink-grenadier-rig-desc = Все, что нужно для шумной вечеринки: 4 разрывные гранаты, 2 ЭМИ гранаты и 2 минибомбы в разгрузочном жилете.
...
uplink-access-breaker-name = Прерыватель доступа
...
uplink-saw-advanced-desc = Передовой хирургический инструмент, разработанный для разрезания как плоти, так и костей.
# Armor
...
uplink-clothing-outer-vest-web-elite-name = Элитный жилет "Паутина"
uplink-clothing-outer-vest-web-elite-desc = Синтетический бронежилет. Эта модель дополнена стропами и термостойкими волокнами.
...
uplink-fake-mindshield-desc = Переключаемый имплантат, способный имитировать те же передачи, которые испускает настоящий щит разума, когда он включён, обманывая способные Heads-up дисплеи, заставляя их думать, что у вас есть щит разума (имплантат марки NanoTrasen не предоставляется).
...
uplink-smuggler-satchel-desc = Удобная подозрительная сумка. Достаточно плоская, чтобы поместиться под напольной плиткой.
